...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1,
        ...
        self.conv2 = Conv2d(planes * 2, planes * 4, kernel_size=3,
                               stride=stride, padding=1, groups=groups,
                               bias=False)
        self.bn2 = nn.BatchNorm2d(planes * 4)
        self.conv3 = Conv2d(planes * 4, planes * 4, kernel_size=1,
                               bias=False)
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        if input_3x3:
            layer0_modules = [
                ('conv1', nnConv2d(3, 64, 3, stride=2, padding=1,
                                    bias=False)),
                ...
                ('conv3', Conv2d(64, inplanes, 3, stride=1, padding=1,
                                    bias=False)),
            ...
            layer0_modules = [
                ('conv1', Conv2d(3, inplanes, kernel_size=7, stride=2,
